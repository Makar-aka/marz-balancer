...
**MarzBalancer** — это FastAPI-приложение для мониторинга и агрегации статистики по нодам Marzban. Сервис собирает информацию о состоянии, клиентах и трафике всех подключённых нод.
Неплохой помощьник для администраторов Marzban, позволяющий быстро оценить состояние всей сети нод.
В разработке.\
...
- Автоматическое и ручное переподключение к ноде при отвале или зависании. 
